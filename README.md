...
#### 🎯 **DevOps-инженер** | WB-tech
`2025 - настоящее время`
<ul>
<li>📁 Разработал и внедрил систему мониторинга для 50+ сервисов</li>
<li>💾 Снизил время реакции на инциденты на 25% через настройку Alertmanager</li>
<li>📌 Оптимизировал использование ресурсов Kubernetes на 25%</li>
<li>📔 Обеспечивал мониторинг 100+ MCA-сервисов</li>
<li>🤖 Реализовал дашборды Grafana для бизнес-метрик</li>
</ul>

#### 📊 **Специалист мониторинга MSA** | ВТБ  
`2024 - 2025`
<ul>
   <li> 🔍 Мониторинг MSA-платформ и распределенных систем</li>
   <li> 🚨 Анализ и локализация инцидентов</li>
   <li> 💊 Проводил деплой на тестовые среды с соблюдением SLA</li>
   <li> 📟 Участвовал в постмортемах и улучшении процессов</li>
</ul>

#### 💳 **Старший инженер сопровождения АС** | Сбербанк
`2022 - 2023`
<ul>
   <li> 🔒 Управление доступом и безопасностью </li>
   <li> 🛠️ Парсинг логов и выявление проблемы </li>
   <li> ⚡ Актуализация инструкций ТП </li>
</ul>
